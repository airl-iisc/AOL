clc
clear
%% Preliminary Parameters and variables %% remember to set the faulty robot percentage

T = 600; % discrete-time steps
N = 5; % total no. of robots, check for 5,10,15,20,25,30 one by one
NTg = 1; % no. of targets
...
etaw_val = [1 5 10];
ea1_val = [1 5 10 20];
ea2_val = [0.01 0.1 2 5];
ew1_val = [1 5 10 20];
ew2_val = [0.01 0.1 1 2 5 10];
pmag_val = [0.01 0.1 1 2 5 10];

mean_score = zeros(length(pmag_val),length(ew2_val),length(ew1_val),length(ea2_val),length(ea1_val),length(etaw_val),length(Tp_val));
std_score = zeros(length(pmag_val),length(ew2_val),length(ew1_val),length(ea2_val),length(ea1_val),length(etaw_val),length(Tp_val));
...
mean_score(k1,k2,k3,k4,k5,k6,k7) = mean(cumul_closeness_score_tot_avg);
std_score(k1,k2,k3,k4,k5,k6,k7) = std(cumul_closeness_score_tot_avg);
