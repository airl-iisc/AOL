...
mean_score = zeros(length(pmag_val),length(ea2_val),length(ea1_val),length(etaw_val),length(Tp_val));
std_score = zeros(length(pmag_val),length(ea2_val),length(ea1_val),length(etaw_val),length(Tp_val));
...
mean_score(k1,k2,k3,k4,k5) = mean(cumul_closeness_score_tot_avg);
std_score(k1,k2,k3,k4,k5) = std(cumul_closeness_score_tot_avg);
