...
threshold_yaw = math.pi   # error of +-2degrees is allowed
...
def done():
    ...
    rospy.logout("%d %d",current_pos.x,current_pos.y)
...
def main():
    ...
    pub = rospy.Publisher("/robot5/cmd_vel" , Twist , queue_size=10)
    sub = rospy.Subscriber("/robot5/volta_base_controller/odom" , Odometry , callback = calc_pos_rpy)
