...
def change_state(n):
    ...
    state = n
    print("State Changed to {0}  {1}".format(n , function[state]))
...
def main():
    ...
    pub = rospy.Publisher("robot5/cmd_vel" , Twist , queue_size=1)
    sub = rospy.Subscriber("robot5/scan_filtered" , LaserScan , callback)
